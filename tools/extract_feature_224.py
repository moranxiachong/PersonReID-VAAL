...
if __name__ == '__main__':
    ...
    model_info_224 = [('/data2/zhihui/my/reid_strong_baseline/logs/se_resnext101_Adam_part_0_2048_sample_softmax_H224_W224/net_150.pth', 0),
                      ...
                      ('/data2/zhihui/my/reid_strong_baseline/logs/se_resnext101_Adam_part_2_2048_sample_softmax_H224_W224/net_175.pth', 2),
                      ('/data2/zhihui/my/reid_strong_baseline/logs/se_resnext101_Adam_part_no_2048_sample_softmax_H224_W224/net_150.pth', -1)]

    for item in model_info_224:
        ...
        result = {'features':test_features_norm, 
                  ...
                  'names':name_list,
                  'num_query':num_query}
        save_file(result, 'features/result_three_part_%s_softmax_H224_W224.pkl' % str(part))
