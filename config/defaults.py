...
_C.MODEL.PRETRAIN_PATH2 = ''
_C.MODEL.ONCE_LOAD = 'no'
_C.MODEL.ONLY_BASE = 'no'
_C.MODEL.WITHOUT_FC = 'no'

_C.MODEL.FREEZE_BASE = False
_C.MODEL.FREEZE_BASE_EPOCH = 25
...
_C.INPUT.PADDING = 10
_C.INPUT.SIZE_DOWN = [128,64]
_C.INPUT.SIZE_UP = [420,140]
_C.INPUT.DEGREE = 15
...
_C.DATASETS.ID_BALANCE = 'off'
#_C.DATASETS.PATH = '/raid/home/zhihui/reid_strong_baseline/data/market1501/image_map_direction_2.pkl'
_C.DATASETS.PATH = ''
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
...
_C.DATALOADER.TRANSFORM = 'init'
_C.DATALOADER.PART = -1
# ---------------------------------------------------------------------------- #
# Solver
# ---------------------------------------------------------------------------- #
_C.SOLVER = CN()
...
_C.SOLVER.MY_OPTIMIZER = "no"
_C.SOLVER.MY_OPTIMIZER_NAME = "SGD"
_C.SOLVER.LR = 0.1
_C.SOLVER.MY_SCHEDULER = "no"
_C.SOLVER.MY_SCHEDULER_NAME = "SL"
_C.SOLVER.MY_SCHEDULER_STEP = [20, 50, 70]
_C.SOLVER.MY_WARMUP = "no"
_C.SOLVER.MY_WARMUP_EPOCH = 3
_C.SOLVER.MY_WARMUP_FACTOR = 1.5
_C.SOLVER.MIXUP=False
_C.SOLVER.RICAP=False
